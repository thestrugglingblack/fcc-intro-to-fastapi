...
def test_user(client):
    user_data = {"email": "janedoe@email.com", "password": "password1234"}
    res = client.post('/users/', json=user_data)
...
'''
Addresses authentication and authorization at the beginning of requests to help with the posting tests
'''
...
def test_posts(test_user, client):
    ...
    post_map = map(create_user_model, post_data)
    posts = list(post_map)
